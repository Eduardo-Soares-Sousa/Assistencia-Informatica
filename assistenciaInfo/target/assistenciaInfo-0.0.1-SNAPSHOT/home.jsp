        ...
        <div class="form-box register">
            ...
            <form action="registerClient" method="post">
                <div id="etapa1">
                    ...
                    <button type="button" class="btn" onclick="mostrarEtapa2()">Avançar</button>
                    <div class="login-register">
                        <p>
                ...
                <div id="etapa2" class="etapa2" style="display:none;">
                    <div class="input-box">
                    ...
                    <button type="button" class="btn etapa1" onclick="voltarEtapa1()">Voltar</button>
